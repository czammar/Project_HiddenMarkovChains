...
####----- kalman filter and smoother function linear gaussian case in one dimension -----#####
...
# Simulation with hidden variablex x_i, following a trigonemetric function with gaussian noise
...
# We calculate kallman filter and smoother and save results
...
####---- Plots (see slides 61 and 62 of pdf file  Hidden_Markov_Models_7Nov2019) ----###
